                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Cadastro - Lojas e Regionais</h5>
                                                    ...
                                                    <form class="" action="cadastro-relacao-lojas-regionais.php?definicoes=true" method="post" id="cadastrar-lojas-regionais">
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group"><label for="mes" class="">Mês</label>
                                                                    <select class="form-control" id="mes" name="mes" required>
                                                                        <option selected="" value="" disabled="">Selecione o Mês</option>
                                                                        <option id="01" value="01">Janeiro</option>
                                                                        <option id="02" value="02">Fevereiro</option>
                                                                        <option id="03" value="03">Março</option>
                                                                        <option id="04" value="04">Abril</option>
                                                                        <option id="05" value="05">Maio</option>
                                                                        <option id="06" value="06">Junho</option>
                                                                        <option id="07" value="07">Julho</option>
                                                                        <option id="08" value="08">Agosto</option>
                                                                        <option id="09" value="09">Setembo</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group"><label for="ano" class="">Ano</label>
                                                                    <select class="form-control" id="ano" name="ano" required>
                                                                        <option selected="" value="" disabled="">Selecione o Ano</option>
                                                                        ...
                                                                        <option id="2049" value="2049">2049</option>
                                                                        <option id="2050" value="2050">2050</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <button class="mt-2 btn btn-primary" type="submit">Definir</button>
                                                    </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Lista - Lojas e Regionais</h5>
                                                <?php
                                                    include 'tabelas.php';
                                                    ?>

                                                        <table id="tabelaLojaRegional" class="display" cellspacing="0" width="100%">
                                                                <thead>
                                                                    <tr>
